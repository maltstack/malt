use malt_protocol::codec::{
    make_envelope,
    DOMAIN_HANDSHAKE, DOMAIN_SHELL, DOMAIN_INPUT, DOMAIN_MUX,
    DOMAIN_SESSION, DOMAIN_TASK, DOMAIN_RENDER, DOMAIN_SYSTEM,
    MSG_HELLO, MSG_HELLO_ACK, MSG_ERROR,
    MSG_COMMAND_OUTPUT, MSG_SHELL_READY, MSG_PROMPT,
    MSG_KEY_EVENT, MSG_MOUSE_EVENT, MSG_PASTE, MSG_RESIZE,
    MSG_SPLIT_PANE, MSG_CLOSE_PANE, MSG_RESIZE_PANE, MSG_FOCUS_PANE,
    MSG_CREATE_SESSION, MSG_ATTACH_SESSION, MSG_DETACH_SESSION, MSG_DESTROY_SESSION,
    MSG_TASK_START, MSG_TASK_PROGRESS, MSG_TASK_COMPLETE, MSG_TASK_FAIL,
    MSG_RENDER_BATCH, MSG_FRAME_ACK, MSG_INITIAL_STATE,
